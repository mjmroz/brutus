...
Usage:
    ...
    python run_coverage.py --fast       # Skip slow integration tests
...
def main():
    ...
    parser.add_argument(
        '--utils', action='store_true', 
        help='Only run utils comprehensive tests'
    )
    parser.add_argument(
        '--core', action='store_true',
        help='Only run core module tests'
    )
    parser.add_argument(
        '--analysis', action='store_true',
        help='Only run analysis module tests'
    )
    parser.add_argument(
        '--data', action='store_true',
        help='Only run data module tests'
    )
    parser.add_argument(
        ...
        test_suites = [
            (
                ["python", "-m", "pytest", 
                 ...
                 "--cov=src.brutus", "--cov-append", "--cov-report=term-missing", "-v"],
    ...
    for description, elapsed, success in sorted(all_times, key=lambda x: x[1], reverse=True):
