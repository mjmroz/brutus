...
from brutus.priors import (
    logp_imf, logp_ps1_luminosity_function,
    logp_parallax, logp_parallax_scale, convert_parallax_to_scale,
    logp_galactic_structure, logn_disk, logn_halo,
...
class TestGalacticPriors:
    ...
    def test_logp_galactic_structure_with_components(self):
        ...
        coord = SkyCoord(ra=90., dec=45., unit='deg')
...
class TestIntegration:
    ...
    def test_prior_integration_workflow(self, simulated_stellar_data):
        ...
        logp_gal = logp_galactic_structure(data['distances'][idx], 
                                          data['coords'][idx])
