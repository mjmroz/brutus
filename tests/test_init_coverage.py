...
def test_all_attribute():
    ...
    expected_items = [
        '__version__', 'Isochrone', 'EEPTracks', 
...
def test_quick_star_fit_not_implemented():
    ...
    with pytest.raises(NotImplementedError, match="Convenience functions will be implemented in Phase 2"):
...
def test_module_level_constants():
    ...
    expected_attrs = [
        '__version__', '__all__', '__doc__',
        'Isochrone', 'EEPTracks', 'fetch_grids', 'load_models',
        'quick_star_fit', 'quick_cluster_fit'
    ]
