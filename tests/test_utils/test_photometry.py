...
try:
    from brutus.utils.photometry import magnitude, inv_magnitude, luptitude, inv_luptitude
except ImportError:
    ...
    try:
        ...
        pytest.skip("brutus utils not available - skipping tests", allow_module_level=True)
...
class TestLuptitudeConversions:
    ...
    def test_luptitude_roundtrip(self, skynoise):
        ...
        flux_recovered, flux_err_recovered = inv_luptitude(lupt, lupt_err, skynoise, zeropoints)
