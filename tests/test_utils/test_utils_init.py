...
class TestUtilsInit:
    ...
    def test_successful_imports(self):
        ...
        for func_name in expected_functions:
            ...
            assert hasattr(brutus.utils, func_name), f"{func_name} not available in module"
    ...
    def test_import_structure_consistency(self):
        ...
        photometry_funcs = ['magnitude', 'inv_magnitude', 'luptitude', 'inv_luptitude', 'add_mag', 'phot_loglike']
