...
__all__ = [
    "logn_disk", "logn_halo", "logp_feh", "logp_age_from_feh", 
...
def logn_halo(R, Z, R_solar=8.2, Z_solar=0.025, R_smooth=2.0,
              eta=4.2, q_ctr=0.2, q_inf=0.8, r_q=6.0):
    """
...
def logp_age_from_feh(age, feh_mean=-0.2, max_age=13.8, min_age=0.0,
                      feh_age_ctr=-0.5, feh_age_scale=0.5,
                      nsigma_from_max_age=2.0, max_sigma=4.0, min_sigma=1.0):
    """
...
def logp_galactic_structure(dists, coord, labels=None, R_solar=8.2, Z_solar=0.025,
                           ...
                           max_age=13.8, min_age=0.0, feh_age_ctr=-0.5, feh_age_scale=0.5,
                           nsigma_from_max_age=2.0, max_sigma=4.0, min_sigma=1.0,
    ...
    coords = SkyCoord(l=ell * units.deg, b=b * units.deg,
                      distance=dists * units.kpc, frame='galactic')
    ...
    if labels is not None:
        ...
        if 'feh' in labels.dtype.names:
            try:
                ...
                feh_lnp_thin = logp_feh(feh, feh_mean=feh_thin, 
                                       feh_sigma=feh_thin_sigma) + lnprior_thin
                feh_lnp_thick = logp_feh(feh, feh_mean=feh_thick,
                                        feh_sigma=feh_thick_sigma) + lnprior_thick
                feh_lnp_halo = logp_feh(feh, feh_mean=feh_halo,
                                       feh_sigma=feh_halo_sigma) + lnprior_halo
        ...
        if 'loga' in labels.dtype.names:
            try:
                ...
                age_lnp_thin = logp_age_from_feh(
                    age, feh_mean=feh_thin, max_age=max_age, min_age=min_age,
                    feh_age_ctr=feh_age_ctr, feh_age_scale=feh_age_scale,
                    nsigma_from_max_age=nsigma_from_max_age,
                    max_sigma=max_sigma, min_sigma=min_sigma) + lnprior_thin
                    
                age_lnp_thick = logp_age_from_feh(
                    age, feh_mean=feh_thick, max_age=max_age, min_age=min_age,
                    feh_age_ctr=feh_age_ctr, feh_age_scale=feh_age_scale,
                    nsigma_from_max_age=nsigma_from_max_age,
                    max_sigma=max_sigma, min_sigma=min_sigma) + lnprior_thick
                    
                age_lnp_halo = logp_age_from_feh(
                    age, feh_mean=feh_halo, max_age=max_age, min_age=min_age,
                    feh_age_ctr=feh_age_ctr, feh_age_scale=feh_age_scale,
                    nsigma_from_max_age=nsigma_from_max_age,
                    max_sigma=max_sigma, min_sigma=min_sigma) + lnprior_halo
